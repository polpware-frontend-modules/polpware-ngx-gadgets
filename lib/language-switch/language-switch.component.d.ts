...
export declare class LanguageSwitchComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<LanguageSwitchComponent, "polp-gadget-language-switch", never, { "langOptions": "langOptions"; "initValue": "initValue"; "size": "size"; }, { "changed": "changed"; }, never, never, false, never>;
}
